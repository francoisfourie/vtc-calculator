...
function setResult(value)
{
   ...
   // $("#result").addClass("light-border");
    ...
    $("#actionSection").html(`<button type="button" class="btn btn-secondary" id="captureAndEmail">Email</button>
        <button type="button" class="btn btn-secondary" id="captureAndWhatsApp">Download</button>`);
